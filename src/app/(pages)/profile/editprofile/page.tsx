          ...
          <section className="self-start ">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              ...
              {profileImageUrl ? (
                ...
                <div className="flex flex-col"><h1 className="self-stretch mt-16 text-4xl font-bold text-neutral-800 text-opacity-90 ">
                  JOESOSEXY
                </h1>
                
                 <div className="mt-24">
                  <input type="file" id="profileImage" onChange={handleImageChange} accept="image/*" className="hidden"/>
                <label htmlFor="profileImage" className="flex cursor-pointer justify-center px-9 py-2 text-lg font-medium text-white rounded-md bg-zinc-800 ">
                  Upload Photo
                </label>
                </div>     
                ...
                <div className="flex flex-col grow items-start py-7 pr-20 pl-5 rounded-md border border-solid shadow-sm border-black border-opacity-10 max-md:pr-5 max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="w-full flex flex-col">
                          <div className="grid w-full max-w-sm items-center gap-1.5 mb-2">
                            ...
                            <Input type="name" id="name" placeholder="Name"  className="text-base"/>
                          </div>
                          ...
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            ...
                            <Input type="username" id="username" placeholder="Username"  className="text-base"/>
                          </div>
                          ...
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            ...
                            <Input type="password" id="password" placeholder="Password"  className="text-base"/>
                          </div>
                          ...
                          <div className="grid w-full max-w-sm items-center gap-1.5 pb-4">
                            ...
                            <Input type="password" id="password" placeholder="Confirm your password"  className="text-base"/>
                          </div>
                      </div>
                  </div>
              ...
              <section className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow px-5 pt-7 pb-20 rounded-md border border-solid shadow-sm border-black border-opacity-10 max-md:px-5 max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="mt-8 text-lg tracking-normal text-zinc-700 text-opacity-80 max-md:mt-10 max-md:max-w-full">
                    ...
                    <Textarea  placeholder="Describe yourself..."className="resize-none text-lg h-32" 
                    maxLength={charLimit}
                ...
                <div className="flex flex-col grow px-5 pt-7 pb-20 rounded-md border border-solid shadow-sm border-black border-opacity-10 ">
                     <h2 className="font-semibold text-xl text-center ">Edit Details</h2>
                </div>  
              </section>
          </div>
        </div>
